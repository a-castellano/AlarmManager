...
func TestChangeAlarmFailed(t *testing.T) {
	...
	if changeModeError == nil {
		...
		if changeModeError.Error() != "Device 'Test Device' failed to change state to disarmed, error was 'param is illegal ,please check it'." {
			t.Errorf("Device Manager change mode error should be \"Device 'Test Device' failed to change state to disarmed, error was 'param is illegal ,please check it'.\" but error was '%s'.", changeModeError)
		}
	}
}

func TestChangeAlarmFailedBecauseCorruptJson(t *testing.T) {
	...
	if changeModeError == nil {
		...
		if changeModeError.Error() != "unexpected end of JSON input" {
			t.Errorf("Device Manager change mode error should be \"unexpected end of JSON input\" but error was '%s'.", changeModeError)
		}
	}
}

func TestChangeAlarm(t *testing.T) {
